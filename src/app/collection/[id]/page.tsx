    ...
    <>
      <main className="container mx-auto px-6 py-12 md:py-20 mt-16 max-w-7xl min-h-screen">
        <div className="mb-10 md:mb-16">
          <Link href="/albums" prefetch={true} className="inline-flex items-center gap-2 text-text-muted hover:text-primary-neutral transition-colors mb-6 text-sm font-medium">
